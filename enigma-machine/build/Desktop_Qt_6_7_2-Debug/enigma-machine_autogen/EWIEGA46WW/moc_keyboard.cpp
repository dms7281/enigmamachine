...
struct qt_meta_stringdata_CLASSKeyboardENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSKeyboardENDCLASS = QtMocHelpers::stringData(
    "Keyboard",
    "keyOutput",
    "",
    "keyPress",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSKeyboardENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Keyboard::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSKeyboardENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSKeyboardENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSKeyboardENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Keyboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Keyboard::*)(char );
            if (_t _q_method = &Keyboard::keyOutput; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Keyboard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSKeyboardENDCLASS.stringdata0))
...
// SIGNAL 0
void Keyboard::keyOutput(char _t1)
{
